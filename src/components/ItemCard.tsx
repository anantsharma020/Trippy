...
import { CATEGORY_EMOJI, itemReactions, itemComments } from '../lib/data'
...
export default function ItemCard({ item, trip: _trip, onOpen, showSchedule = true }: {
  ...
  return (
    <button onClick={() => onOpen(item)}
      className="flex w-full items-start gap-3 rounded-2xl bg-ink-900/70 p-3 text-left ring-1 ring-ink-800 transition hover:ring-ink-700">
